...
/*SZY comments: if you use VMA structure, you should explain it in detail!*/
	check_vma_struct();
	check_pgfault();
...
/* SZY comments: Does this function really check the pgfault handler? how does it do this?  explain*/
static void check_pgfault(void)
{
	size_t nr_free_pages_store = nr_free_pages();
